...
/** @type {string} */
const CACHE_VERSION = '1736022410|4248869094';
/** @type {string} */
const CACHE_PREFIX = 'PersonalPVT-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'PersonalPVT.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["PersonalPVT.html","PersonalPVT.js","PersonalPVT.offline.html","PersonalPVT.worker.js","PersonalPVT.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["PersonalPVT.wasm","PersonalPVT.pck"];
